...
// const numbers = [3, 7, 2, 8, 1, 11, 22];
// const sortedNumbers = [...numbers].sort();

// console.log('numbers: ', numbers);
// console.log('sortedNumbers: ', sortedNumbers);

// const strArr = ['Maggie', 'Amanda', 'Corey', 'Cora', 'Jordan', 'ana'];
// const sortedStrArr = [...strArr].sort();

// console.log('strArr: ', strArr);
// console.log('sortedStrArr: ', sortedStrArr);

//? Сортування чисел та рядків за умови
/*
1 ітерація
a = 3;
b = 7;
...
// const sortByModel = (allCars, order) => {
//   if (order === 'asc') {
//     return [...allCars].sort((a, b) => a.model.localeCompare(b.model));
//   }

//   return [...allCars].sort((a, b) => b.model.localeCompare(a.model));
// };
