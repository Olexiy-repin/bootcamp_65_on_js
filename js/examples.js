...
//   // let { names, phones } = {names: 'Jacob,William,Solomon,Artemis',phones: '89001234567,89001112233,890055566377,890055566300',}
...
/*
? Напиши функцію getStockReport(companyInfo), щоб вона приймала об'єкт параметрів із властивостями companyName і stock і виводила репорт
? про кількість товарів на складі будь-якої компанії.
*/

// const getStockReport = function (companyInfo) {
