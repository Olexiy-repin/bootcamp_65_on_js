...
//       stoneInfo => stoneInfo.name.toLowerCase() === stoneName.toLowerCase()
//     );

//     if (stone === undefined) {
//       return `Такого каменю, як ${stoneName} немає!`;
//     }
...
// console.log(chopShop.calcTotalPrice('Aconit')); // Такого каменя не знайдено
