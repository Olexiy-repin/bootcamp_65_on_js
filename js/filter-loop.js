...
// const marvelHeroes = heroes.filter(hero => hero.franchise.toLowerCase() === 'marvel');

// const dcHeroes = heroes.filter(hero => hero.franchise.toLowerCase() === 'dc');
...
//   const filteredCarsByPrice = allCars.filter((car, idx, arr) => {
...
// Скорочена версія
// const filterByPrice = (allCars, threshold) => allCars.filter(car => car.price <= threshold);
...
//   return allCars.filter((car, idx, arr) => {
//     return car.onSale;
//   });
// };
...
// Скорочена версія
// const getCarsWithDiscount = allCars => allCars.filter(car => car.onSale);
...
// Скорочена версія
// const getCarsWithType = (allCars, type) => {
//   return allCars.filter(car => car.type.toLowerCase() === type.toLowerCase());
// };
